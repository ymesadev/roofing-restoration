      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:1-800-555-ROOF" className="flex items-center gap-2 text-orange-400 font-semibold">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4">
            ...
            <a href="tel:1-800-555-ROOF" className="block py-2 text-orange-400 font-semibold">
              1-800-555-ROOF
            </a>
          </div>
        )}
